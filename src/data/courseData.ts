...
export const courseData = [
  {
    id: "1",
    title: "প্রাথমিক পাইথন প্রোগ্রামিং কোর্স",
    description:
  ...
  {
    id: "2",
    title: "ওয়েব ডেভেলপমেন্ট ফান্ডামেন্টাল",
    description:
